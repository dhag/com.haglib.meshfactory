...
namespace MeshFactory.PMX
{
    ...
    public class PMXImportPanel : Tools.IToolPanelBase
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> _localize = new()
        {
            ...
            ["ImportBones"] = new() { ["en"] = "Import Bones", ["ja"] = "ボーン読込" },
            ["ImportMorphs"] = new() { ["en"] = "Import Morphs (Future)", ["ja"] = "モーフ読込（将来）" },
        ...
        private void DrawSettingsSection()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                string[] modeOptions = new[] { T("ModeAppend"), T("ModeReplace") };
            ...
            using (new EditorGUILayout.HorizontalScope())
            {
                ...
                if (GUILayout.Button(T("NoScale")))
                    _settings = PMXImportSettings.CreateNoScale();
            }
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                _settings.ImportBones = EditorGUILayout.Toggle(T("ImportBones"), _settings.ImportBones);

                EditorGUI.BeginDisabledGroup(true);
                _settings.ImportMorphs = EditorGUILayout.Toggle(T("ImportMorphs"), _settings.ImportMorphs);
